    ...
    override fun consume(iterator: AstParserIterator<CssTokenKind>): AtRule {
        ...
        var atRule =
            AtRule(
                ...
                name =
                    content.substring(current.startOffset, current.endOffset).also {
        ...
        while (iterator.hasNext()) {
            ...
            when (next.kind) {
                ...
                CssTokenKind.EndOfFile -> {
                    iterator.parserError(content, "Incomplete @rule.")
                }
