...
class StyleSheetConsumerTest {
    @Test
    fun `when comma-separated selectors present - then create StyleSheet with QualifiedRule with multi selectors`() {
        // Arrange
        val tokens =
            listOf(
                                                                    ...
                                                                    selectors =
                                                                        listOf(
                                                                            ...
                                                                            Selector.Class(
                                                                                ...
                                                                                name = "homepage",
                                                                                combinator =
                                                                                    CssCombinator.DescendantCombinator
                                                                            ),
                                                                            Selector.Class(
                                                                                location =
                                                                                    CssLocation(
                                    ...
                                    children =
                                        listOf(
                                            Declaration(
                                                location =
                                                    CssLocation(
                                                        source = content.substring(16, 33),
                                                        start = 16,
                                                        end = 33
                                                    ),
                                                property = "background",
                                            ...
                                            Declaration(
                                                location =
                                                    CssLocation(
                                                        source = content.substring(38, 50),
                                                        start = 38,
                                                        end = 50
                                                    ),
                                                property = "color",
                                    ...
                                    children =
                                        listOf(
                                            Declaration(
                                                location =
                                                    CssLocation(
                                                        source = content.substring(67, 84),
                                                        start = 67,
                                                        end = 84
                                                    ),
                                                property = "background",
                                            ...
                                            Declaration(
                                                location =
                                                    CssLocation(
                                                        source = content.substring(89, 108),
                                                        start = 89,
                                                        end = 108
                                                    ),
    ...
    private fun buildStyleSheetConsumer(content: String): StyleSheetConsumer {
        ...
        val declarationConsumer =
            DeclarationConsumer(
                content = content,
                valueConsumer = valueConsumer
            )
        val selectorListItemConsumer =
            SelectorListItemConsumer(
                content = content,
                simpleSelectorConsumer = simpleSelectorConsumer
            )
        val declarationBlockConsumer =
            SimpleDeclarationBlockConsumer(
                content = content,
                declarationConsumer = declarationConsumer
            )

        val qualifiedRuleConsumer =
            QualifiedRuleConsumer(
                content = content,
                selectorListItemConsumer = selectorListItemConsumer,
                blockConsumer = declarationBlockConsumer
            )

        val simpleRuleBlockConsumer =
            SimpleRuleBlockConsumer(
                content = content,
